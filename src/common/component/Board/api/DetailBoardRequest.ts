...
export const exampleData: GetBoardDetailRequest = {
  post: {
    ...
    imageUrl:
      "https://readdy.ai/api/search-image?query=modern%20book%20club%20meeting%20with%20people%20discussing%20literature%20in%20a%20contemporary%20minimalist%20setting%20with%20warm%20lighting%20and%20comfortable%20seating%20arrangement&width=1200&height=675&seq=1&orientation=landscape",
  ...
  replies: [
    {
      ...
      reReply: [
        ...
        },
        {
          ...
          code: "POST_1",
          content:
            "저도 그렇게 생각합니다!저도 그렇게 생각합니다!저도 그렇게 생각합니다!저도 그렇게 생각합니다!저도 그렇게 생각합니다!저도 그렇게 생각합니다!저도 그렇게 생각합니다!저도 그렇게 생각합니다!",
          p_reply_code: 1,
          del_yn: false,
          create_at: "2023-02-24",
          likes: 3,
