                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-1 gap-4 sm:grid-cols-4">
                                    <div className="sm:col-span-1">
                                        ...
                                        <input type="date" className="mt-1 block w-full border-gray-300 !rounded-button shadow-sm focus:border-custom focus:ring-custom"/>
                                    </div>
                                    <div className="sm:col-span-1">
                                    ...
                                    <div className="sm:col-span-2">
                                        ...
                                        <div className="mt-1 relative rounded-md shadow-sm">
                                            <input type="text" className="block w-full border-gray-300 !rounded-button pr-10 focus:border-custom focus:ring-custom" placeholder="검색어를 입력하세요"/>
                                    ...
                                    <table className="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            <tr>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">2024년 서비스 업데이트 안내</td>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">공개</span>
                                                </td>
                                ...
                                <div className="flex items-center justify-between border-t border-gray-200 px-4 py-3 sm:px-6">
                                    <div className="flex flex-1 justify-between sm:hidden">
                                        <button className="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium !rounded-button bg-white text-gray-700 hover:bg-gray-50">이전</button>
                                        <button className="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium !rounded-button bg-white text-gray-700 hover:bg-gray-50">다음</button>
                                    </div>
                                    <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                                        <div>
                                            <p className="text-sm text-gray-700">
                                                총 <span className="font-medium">20</span> 개 중 <span className="font-medium">1</span> - <span className="font-medium">10</span>
                                            </p>
                                        </div>
                                        <div>
