    ...
    return (
        <div className="min-h-screen flex flex-col bg-gray-50 overflow-x-hidden">
                ...
                <div className="max-w-[1440px] mx-auto px-8 flex items-center justify-between h-16">
                    <div className="flex items-center">
                        ...
                        <nav className="flex space-x-8">
                            ...
                            <a href="#" className="text-gray-600 hover:text-gray-900">멤버십</a>
                            <a href="#" className="text-gray-600 hover:text-gray-900">장기 모임</a>
            ...
            <footer
                ...
                style={{
                    backgroundImage: 'url("https://static.readdy.ai/image/7c947f0a614a0de80ab998c78f59b0ef/68987b76fdbe6bcc791c9ab28eb2d958.png")',
