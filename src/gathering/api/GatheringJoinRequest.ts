...
export const sampleQuestions: RecruitQuestion[] = [
    ...
    { id: 2, question: "최근에 읽은 책 중 가장 인상 깊었던 책은 무엇이며, 그 이유는 무엇인가요?", required: true, maxLength: 500 },
    ...
    { id: 5, question: "모임에서 진행하고 싶은 활동이나 제안이 있다면 자유롭게 작성해주세요.", required: true, maxLength: 500 }
];
