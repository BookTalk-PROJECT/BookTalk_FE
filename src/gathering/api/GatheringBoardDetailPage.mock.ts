...
export const exampleData: GatheringBoardDetailData = {
    post: {
        id: 1,
        title: "독서모임 후기 1",
        author: "이름님",
...
//모임 게시글 상세 조회
export const fetchGatheringBoardDetail = async (gatheringId: string, postId: string): Promise<GatheringBoardDetailData> => {
    const response = await axios.get<GatheringBoardDetailData>(`${baseURL}/gatheringlist/${gatheringId}/gatheringboard/${postId}`);
